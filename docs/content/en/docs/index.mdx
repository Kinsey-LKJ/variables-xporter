...
<Steps>
### Organize your Figma Variables according to [organization suggestions](/docs/organizing-your-variables), or start with our [template](https://www.figma.com/community/file/1529796560368045075)
...
<figure className="mt-6 max-w-[400px]">
  <>![Click export and view results](/get-started/click-export-and-view-result.png)</>
  <figcaption>
    Click export and view results
  </figcaption>
</figure>
