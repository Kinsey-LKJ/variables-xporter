...
- Strictly follow Tailwind CSS configuration [naming structure](/docs/organizing-your-variables/principles/#naming-structure)
...
<Cards.Card
  className="mt-4"
  icon={<Box />}
  title="View Complete Design Tokens Template"
...
<Cards.Card
  className="mt-4"
  icon={<Box />}
  title="View Custom shadcn/ui Theme Template"
