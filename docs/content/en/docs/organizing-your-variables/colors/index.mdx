...
Variables Xporter provides powerful color processing capabilities, automatically generating color variables that comply with Tailwind CSS rules. During development, you can easily use opacity modifiers to [flexibly adjust the transparency of colors](https://tailwindcss.com/docs/colors#adjusting-opacity) without the need for additional variable definitions.
...
[^1]: The `DEFAULT` keyword is a way to organize variable hierarchy, [learn more](/docs/organizing-your-variables/principles#using-default-keyword)
