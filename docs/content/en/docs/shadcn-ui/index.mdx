...
Variables Xporter is the first plugin to deeply integrate with shadcn/ui, capable of exporting Figma Variables as shadcn/ui theme configurations (Tailwind CSS), allowing any shadcn/ui component to have different brand colors, density modes, light/dark themes, and more, help you create your design system.
