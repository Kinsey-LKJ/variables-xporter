...
Dans Figma, les designers n'ont qu'à sélectionner les variables de la collection Design Tokens sans se soucier des relations de référence entre variables sous-jacentes. C'est l'avantage du Principe de Sortie Unique—offrir une interface unifiée et claire.
