...
Vous pouvez trouver la liste complète des clés de configuration dans la [Référence de configuration du thème Tailwind CSS](https://tailwindcss.com/docs/theme#configuration-reference).
