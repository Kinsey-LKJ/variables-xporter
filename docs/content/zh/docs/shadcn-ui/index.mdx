...
Variables Xporter 与 shadcn/ui 无缝集成，直接将 Figma Variables 导出为 shadcn/ui 主题配置。支持多品牌颜色、密度模式、明暗主题等，无需手动配置即可转换您的设计系统。

## 开始使用

### 1. 遵循 shadcn/ui 命名规范

为了实现无缝集成，您的 Figma Variables 必须遵循 shadcn/ui 命名规范。以下是 shadcn/ui CSS 变量与对应 Figma Variable 名称的完整映射：
...
在导出格式中选择 shadcn/ui 及您所需的 Tailwind CSS 版本
