...
选择 CSS Variables 导出方式时，Variables Xporter 会生成一个包含所有 CSS Variables 定义的 CSS 文件。这种方式更加简单和灵活，适合不使用 Tailwind CSS 的项目。
...
相较于 [Tailwind CSS](/docs/export-modes/tailwind)，CSS Variables 导出方式对变量组织的要求较低，但是任然建议您遵循良好的组织原则，这样可以：
