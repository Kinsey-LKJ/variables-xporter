...
我们提供了完整的 Figma 变量组织建议，帮助你更好地管理变量，并保证导出结果的可用性。
  ...
  <Cards.Card
    icon={<BookCopy />}
    title="组织你的设计变量"
    href="/organizing-your-variables"
    className="mt-4"
  />
...
<Cards>
  ...
  <Cards.Card
    ...
    href="/features/ignore-tailwind-palette"
  />
  <Cards.Card
    icon={<Merge/>}
    title="合并排版样式"
    href="/features/merge-typography-styles"
  />
  <Cards.Card
    icon={<Proportions />}
    title="CSS 媒体查询模式"
    href="/features/css-media-query-mode"
  />
</Cards>
...
## 开始使用
<Steps>
### 按照 [组织建议](/organizing-your-variables) 整理你的 Figma 变量
