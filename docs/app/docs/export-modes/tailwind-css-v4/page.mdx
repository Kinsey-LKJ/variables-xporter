...
Tailwind CSS V4 是 Tailwind CSS 的最新版本，它引入了许多新的特性和优化。选择 Tailwind CSS V4 导出方式时，Variables Xporter 会生成一个文件：

- `app.css` - 包含所有的 Tailwind CSS 配置和 CSS 变量
